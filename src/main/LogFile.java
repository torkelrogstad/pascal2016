...
public class LogFile {
  ...
  private void writeLogLine(String data) {
    ...
    try {
      ...
      // PrintWriter log = (nLogLines == 0 ?
      //   new PrintWriter(logFileName) :
      //   //boolean here makes stream write to the end of the file,
      //   //not beginning
      //   new PrintWriter(new FileOutputStream(logFileName,true)));

      //commented out code equals following if/else blocks, improved readability
